...
}, Jn = ({ children: e, isGrey: t, hasWave: n, isCenter: r, isCenterDesktop: i, noHover: a, leftBorder: c, revealOnScroll: l = !0, className: u }) => {
	let { ref: d, isVisible: f } = qn({ disabled: !l });
	return /* @__PURE__ */ s("div", {
		ref: d,
		className: `${[
			"cu-card",
