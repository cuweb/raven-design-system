...
import { a as n, c as r, i, o as a, r as o, t as s } from "../_shared/Status-AcUF3hsX.mjs";
...
var D = ({ title: t = "No title available", link: n, extraText: r, as: i = "h2", date: a, datePrefix: o, readTime: s, position: c = "bottom" }) => {
...
}, $ = ({ children: e, isGrey: t, hasWave: n, isCenter: r, isCenterDesktop: i, noHover: a, noImage: o, leftBorder: s, revealOnScroll: c = !0, className: l }) => {
	let { ref: u, isVisible: d } = Q({ disabled: !c });
	return /* @__PURE__ */ p("div", {
		ref: u,
		className: `${[
			"cu-card",
